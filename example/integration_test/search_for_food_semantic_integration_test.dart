...
void runTests() {
  ...
  test('blueberries', () async {
    final result =
        await NutritionAI.instance.searchForFoodSemantic('arándanos ');
    expect(
        result.results,
        anyElement((PassioFoodDataInfo e) =>
            e.foodName.toLowerCase().contains('blueberries')));
    expect(result.alternateNames,
        anyElement((String e) => e.toLowerCase().contains('blueberries')));
  });
